...
<?php
  include "../koneksi.php";
  $kdgejala = $_POST['kodeGejala'];
  $gejala = $_POST['gejala'];

  //cek keberadaan data
  $sqlrs = mysqli_query($koneksi, "SELECT kodeGejala FROM gejala WHERE kodeGejala='$kdgejala'");
  $rs = mysqli_num_rows($sqlrs);
  if ($rs == 0) {
    $perintah = "INSERT INTO gejala (kodeGejala,gejala) VALUES ('$kdgejala','$gejala')";
